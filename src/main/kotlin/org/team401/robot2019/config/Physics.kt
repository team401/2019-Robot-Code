...
object Physics {
    object DrivetrainDynamics: DriveDynamicsTemplate {
        ...
        override val leftKa by Selectable(0.002, 0.0192)
        override val leftKs by Selectable(0.0065, 0.1524)
        override val leftKv by Selectable(0.0133, 0.1466)
        override val momentOfInertia by Selectable(2.0, 1.331905811)
        override val rightKa by Selectable(0.0037, 0.0230)
        override val rightKs by Selectable(0.0051, 0.1396)
        override val rightKv by Selectable(0.0129, 0.1462)
